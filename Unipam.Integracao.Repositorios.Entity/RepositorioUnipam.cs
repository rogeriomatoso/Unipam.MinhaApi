...
using Unipam.Integracao.Repositorios.Interfaces;

namespace Unipam.Integracao.Repositorios.Entity
{
    public abstract class RepositorioUnipam<TDominio, TChave> : IRepsoitoriosUnipam<TDominio, TChave>
         where TDominio : class
    {
        protected DbContext _context;

        public RepositorioUnipam(DbContext context)
        {
            _context = context;
        }
        public void Autalizar(TDominio dominio)
        {
